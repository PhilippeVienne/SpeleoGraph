...
import org.cds06.speleograph.datepicker.animation.BackInterpolator;
...
public final class DatePickerSkin extends HBox implements Skin<DatePicker> {
    ...
    private class AnimatedPopup extends Popup {
        ...
        public void show() {
            super.show();
            //getScene().getRoot().setCache(true);
            getScene().getRoot().setCacheHint(CacheHint.SCALE);
            FadeTransition fadeTransition = new FadeTransition(Duration.seconds(0.2), getScene().getRoot());
            fadeTransition.setFromValue(0);
            fadeTransition.setToValue(1);
            fadeTransition.setInterpolator(new BackInterpolator());
            fadeTransition.playFromStart();

            ScaleTransition scaleTransition = new ScaleTransition(Duration.seconds(0.2), getScene().getRoot());
            scaleTransition.setFromX(0.8);
            scaleTransition.setFromY(0.8);
            scaleTransition.setToY(1);
            scaleTransition.setToX(1);

            scaleTransition.setInterpolator(new BackInterpolator());
            scaleTransition.playFromStart();
            scaleTransition.setOnFinished(new EventHandler<ActionEvent>() {
                @Override
                public void handle(ActionEvent actionEvent) {
                    getScene().getRoot().setCache(false);
                }
            });
        }
...
//        @Override
//        public void hide() {
//            FadeTransition fadeTransition = new FadeTransition(Duration.seconds(.3), getScene().getRoot());
//            fadeTransition.setFromValue(1);
//            fadeTransition.setToValue(0);
//            fadeTransition.setInterpolator(new BackInterpolator());
//            fadeTransition.playFromStart();
//
//            ScaleTransition scaleTransition = new ScaleTransition(Duration.seconds(.3), getScene().getRoot());
